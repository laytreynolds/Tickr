 ...
 * Implementations declare which notification type they support via {@link #supports(Notification)}.
 */
public interface NotificationSender {
    ...
    /**
     * Send the notification. Call only when {@link #supports(Notification)} returns true.
     */
